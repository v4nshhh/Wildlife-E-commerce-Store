...
(function () {
	...
	var userAgent = navigator.userAgent.toLowerCase(),
		...
		plugins = {
			...
			slick: $('.slick-slider'),
			countDown: $(".countdown"),
			toggleButtons: $('.toggle-buttons-js')
		};
	...
	$(function () {
		...
		if(plugins.toggleButtons.length) {
			$('.toggle-buttons-js').find('.button').on('click', function () {
				$('.toggle-buttons-js > .button').removeClass('active');
				$(this).addClass('active');
			})
		}

		$('.form-number-range-input').on('click', function () {
			$('.toggle-buttons-js > .button').removeClass('active');
		})
